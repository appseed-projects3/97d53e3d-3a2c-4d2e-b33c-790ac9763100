...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-12 01:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/97d53e3d-3a2c-4d2e-b33c-790ac9763100.git
$ cd 97d53e3d-3a2c-4d2e-b33c-790ac9763100
```
